...
const StartAProject = ({ pageInfo }: Props) => {
  ...
  return (
    ...
    >
      ...
      {/* right button */}
      <div className="cursor-pointer pr-[32px] pl-[32px] md:pr-[24px] md:pl-[24px] flex gap-[16px] pt-[16px] pb-[16px] border-[1px] rounded-[16px] w-[240px] md:pt-[12px] md:pb-[12px] sm:w-[180px] sm:justify-center border-[#10b981]">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
